...
})(["position:fixed;background:#fff;display:flex;width:100%;height:70px;align-items:center;justify-content:space-between;padding:10px;", " @media(max-width:900px){flex-direction:column;}.logo{img{height:40px;}}.menu{list-style-type:none;display:flex;li{a{text-decoration:none;color:#000;font-size:18px;margin:0 10px;}a.featured{font-family:\"Gotham\";font-weight:500;color:", ";}}}"], padded, theme.red);
...
//# sourceMappingURL=index.js.f0c187ff6e532089741a.hot-update.js.map